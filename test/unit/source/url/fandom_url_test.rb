...
module Source::Tests::URL
  class FandomUrlTest < ActiveSupport::TestCase
    context "Fandom URLs" do
      ...
      should parse_url("https://vignette.wikia.nocookie.net/valkyriecrusade/images/c/c5/Crimson_Hatsune_H.png/revision/latest?cb=20180702031954").into(
        page_url: "https://valkyriecrusade.fandom.com/wiki/File:Crimson_Hatsune_H.png",
      )

      should parse_url("https://static.wikia.nocookie.net/age-of-ishtaria/images/f/f9/Union-List.png/revision/latest/scale-to-width-down/670?cb=20141219153314").into(
        page_url: "https://ishtaria.fandom.com/wiki/File:Union-List.png",
      )

      should parse_url("https://static.wikia.nocookie.net/atelierseries/images/2/22/Marie_%28Front_Page_Art%29.jpg/revision/latest/scale-to-width-down/670?cb=20130129113100").into(
        page_url: "https://atelier.fandom.com/wiki/File:Marie_(Front_Page_Art).jpg",
      )

      should parse_url("https://static.wikia.nocookie.net/kagura/images/9/9f/Kagurapedia_Header.png/revision/latest/scale-to-width-down/650?cb=20171016220119").into(
        page_url: "https://senrankagura.fandom.com/wiki/File:Kagurapedia_Header.png",
      )

      should parse_url("https://static.wikia.nocookie.net/gensin-impact/images/2/22/Character_Kamisato_Ayato_Card.png/revision/latest/scale-to-width-down/281?cb=20220204094446").into(
        page_url: "https://genshin-impact.fandom.com/wiki/File:Character_Kamisato_Ayato_Card.png",
      )

      should parse_url("http://vignette3.wikia.nocookie.net/neptunia/images/2/28/Plutia_B%2BNvZ.png/revision/latest?cb=20160420084622").into(
        page_url: "https://neptunia.fandom.com/wiki/File:Plutia_B%2BNvZ.png",
      )

      should parse_url("http://img3.wikia.nocookie.net/__cb20130523100711/typemoon/images/9/96/Caster_Extra_Takeuchi_design_1.png").into(
        page_url: "https://typemoon.fandom.com/wiki/File:Caster_Extra_Takeuchi_design_1.png",
      )

      should parse_url("https://static.wikia.nocookie.net/virtualyoutuber/images/c/c4/Alicia_Cotton_2nd_Outfit_2.png/revision/latest?cb=20211107035307&path-prefix=vi").into(
        page_url: "https://virtualyoutuber.fandom.com/vi/wiki/File:Alicia_Cotton_2nd_Outfit_2.png",
      )

      should parse_url("http://img3.wikia.nocookie.net/__cb20140404214519/typemoon/fr/images/f/fd/Aozaki_Aoko_Blue.png").into(
        page_url: "https://typemoon.fandom.com/fr/wiki/File:Aozaki_Aoko_Blue.png",
      )

      should parse_url("http://img3.wikia.nocookie.net/__cb20140404214519/typemoon/images/f/fd/Aozaki_Aoko_Blue.png/revision/latest?path-prefix=fr").into(
        page_url: "https://typemoon.fandom.com/fr/wiki/File:Aozaki_Aoko_Blue.png",
      )

      should parse_url("http://img3.wikia.nocookie.net/__cb20140404214519/typemoon/fr/images/thumb/f/fd/Aozaki_Aoko_Blue.png/500px-Aozaki_Aoko_Blue.png").into(
        page_url: "https://typemoon.fandom.com/fr/wiki/File:Aozaki_Aoko_Blue.png",
      )

      should parse_url("http://img3.wikia.nocookie.net/__cb20130520180921/allanimefanon/images/thumb/8/82/2560-1600-104761.jpg/2000px-2560-1600-104761.jpg").into(
        page_url: "https://allanimefanon.fandom.com/wiki/File:2560-1600-104761.jpg",
      )

      should parse_url("https://static.wikia.nocookie.net/p__/protagonist/images/3/3f/Yukiko_Amagi_(BlazBlue_Cross_Tag_Battle%2C_Character_Select_Artwork).png").into(
