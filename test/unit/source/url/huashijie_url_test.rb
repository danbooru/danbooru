...
module Source::Tests::URL
  class HuashijieUrlTest < ActiveSupport::TestCase
    context "Huashijie URLs" do
      ...
      should parse_url("https://huashijie.art/work/detail/237016516").into(
        page_url: "https://www.huashijie.art/work/detail/237016516",
      )
      should parse_url("https://static.huashijie.art/w_d/235129335").into(
        page_url: "https://www.huashijie.art/work/detail/235129335",
      )
      should parse_url("https://static.huashijie.art/hsj/wap/#/detail?workId=235129335").into(
        page_url: "https://www.huashijie.art/work/detail/235129335",
      )
      should parse_url("https://static.huashijie.art/s_pd/325923").into(
        page_url: "https://www.huashijie.art/market/detail/325923",
      )
      should parse_url("https://static.huashijie.art/newmarket/#/product/detail/325923").into(
        page_url: "https://www.huashijie.art/market/detail/325923",
      )
      should parse_url("https://static.huashijie.art/newmarket/?share=1&navbar=0#/product/detail/325923").into(
        page_url: "https://www.huashijie.art/market/detail/325923",
      )

      should parse_url("https://static.huashijie.art/hsj/wap/#/usercenter?userId=13649297").into(
        profile_url: "https://www.huashijie.art/user/index/13649297",
      )
      should parse_url("https://static.huashijie.art/newmarket/#/usercenter/9780156").into(
        profile_url: "https://www.huashijie.art/user/index/9780156",
      )
      should parse_url("https://static.huashijie.art/newmarket/?navbar=0&swapeback=0#/usercenter/9780156?share=1").into(
        profile_url: "https://www.huashijie.art/user/index/9780156",
      )

      should parse_url("https://bsyimgv2.pandapaint.net/v2/work_cover/user/14619015/1713709783854.jpg?image_process=format,WEBP").into(
      ...
      should parse_url("https://bsyimgv2.pandapaint.net/v2/album_cover/user/17873127/1736262275939.png?x-oss-process=style/work_cover&image_process=format,WEBP").into(
      ...
      should parse_url("https://bsyimg.pandapaint.net/v2/work_cover/user/13649297/1714634091547.jpg").into(
        full_image_url: "https://bsyimg.pandapaint.net/v2/work_cover/user/13649297/1714634091547.jpg",
        profile_url: "https://www.huashijie.art/user/index/13649297",
      )
      should parse_url("https://bsyimgv2.pandapaint.net/v2/pd_cover/public/1749455200182.png?x-oss-process=style/work_cover&image_process=format,WEBP").into(
