...
module Source::Tests::URL
  class MoebooruUrlTest < ActiveSupport::TestCase
    context "Moebooru URLs" do
      ...
      should parse_url("https://files.yande.re/image/b66909b940e8d77accab7c9b25aa4dc3/yande.re%20377828.png").into(
        page_url: "https://yande.re/post/show/377828",
      )

      should parse_url("https://files.yande.re/image/2a5d1d688f565cb08a69ecf4e35017ab/yande.re%20349790%20breast_hold%20kurashima_tomoyasu%20mahouka_koukou_no_rettousei%20naked%20nipples.jpg").into(
        page_url: "https://yande.re/post/show/349790",
      )

      should parse_url("https://files.yande.re/image/e4c2ba38de88ff1640aaebff84c84e81/469784.jpg").into(
        page_url: "https://yande.re/post/show/469784",
      )

      should parse_url("https://yande.re/image/b4b1d11facd1700544554e4805d47bb6/.png").into(
      ...
      should parse_url("https://konachan.com/image/5d633771614e4bf5c17df19a0f0f333f/Konachan.com%20-%20270807%20black_hair%20bokuden%20clouds%20grass%20landscape%20long_hair%20original%20phone%20rope%20scenic%20seifuku%20skirt%20sky%20summer%20torii%20tree.jpg").into(
