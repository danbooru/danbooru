...
module Source::Tests::URL
  class NijieUrlTest < ActiveSupport::TestCase
    context "Nijie URLs" do
      ...
      should parse_url("https://pic04.nijie.info/nijie_picture/diff/main/287736_161475_20181112032855_1.png").into(
        page_url: "https://nijie.info/view.php?id=287736",
      )

      should parse_url("http://pic02.nijie.info/nijie_picture/diff/main/0_23473_141_20120913002158.jpg").into(
        page_url: nil,
      )
    end
  end
