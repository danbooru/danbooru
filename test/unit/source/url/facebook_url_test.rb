...
module Source::Tests::URL
  class FacebookUrlTest < ActiveSupport::TestCase
    context "Facebook URLs" do
      ...
      should parse_url("https://scontent-sin1-1.xx.fbcdn.net/hphotos-xtp1/t31.0-8/11254493_576443445841777_7716273903390212288_o.jpg").into(
        page_url: "https://www.facebook.com/photo?fbid=576443445841777",
      )

      should parse_url("https://fbcdn-sphotos-h-a.akamaihd.net/hphotos-ak-xlp1/t31.0-8/s960x960/13173066_623015164516858_1844421675339995359_o.jpg").into(
        page_url: "https://www.facebook.com/photo?fbid=623015164516858",
      )

      should parse_url("https://www.facebook.com/profile.php?id=100007366415557&name=xhp_nt__fblite__profile__tab_bar").into(
        profile_url: "https://www.facebook.com/profile.php?id=100007366415557",
      )

      should parse_url("https://www.facebook.com/profile/100007366415557").into(
        profile_url: "https://www.facebook.com/profile.php?id=100007366415557",
      )

      should parse_url("https://www.facebook.com/p/Chocotoffys-61550637164305/").into(
        profile_url: "https://www.facebook.com/profile.php?id=61550637164305",
      )

      should parse_url("https://www.facebook.com/people/Abandir/61565499492869/").into(
        profile_url: "https://www.facebook.com/profile.php?id=61565499492869",
      )

      should parse_url("https://www.facebook.com/buttersugoi2.0/posts/pfbid052HT8bQg1QzN4V8s7wouB6DEEnP9DudwpuGPtoqgUAg9WC7Ug2Z94gYXtB2S37oBl").into(
        profile_url: "https://www.facebook.com/buttersugoi2.0",
      )

      should parse_url("https://www.facebook.com/sinyu.tang.9").into(
        profile_url: "https://www.facebook.com/sinyu.tang.9",
      )

      should parse_url("https://www.facebook.com/sinyu.tang.9/about").into(
        profile_url: "https://www.facebook.com/sinyu.tang.9",
      )

      should parse_url("https://www.fb.com/sinyu.tang.9").into(
        profile_url: "https://www.facebook.com/sinyu.tang.9",
      )
    end
