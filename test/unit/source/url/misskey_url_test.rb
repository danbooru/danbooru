...
module Source::Tests::URL
  class MisskeyUrlTest < ActiveSupport::TestCase
    context "Misskey URLs" do
      ...
      should parse_url("https://misskey.io/notes/9bxaf592x6#pswp").into(
      ...
      should parse_url("https://misskey.io/user-info/9bpemdns40").into(
        profile_url: "https://misskey.io/users/9bpemdns40",
        user_id: "9bpemdns40",
        username: nil,
      )

      should parse_url("https://misskey.io/@ixy194").into(
        user_id: nil,
        username: "ixy194",
      )

      should parse_url("https://misskey.io/users/9bpemdns40").into(
        user_id: "9bpemdns40",
        username: nil,
      )
    end
