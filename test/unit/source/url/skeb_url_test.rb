  ...
  class SkebUrlTest < ActiveSupport::TestCase
    context "Skeb URLs" do
      should be_image_url(
        ...
        "https://si.imgix.net/17e73ecf/uploads/origins/5097b1e1-18ce-418e-82f0-e7e2cdab1cea?bg=%23fff&auto=format&txt=SAMPLE&fm=mp4&w=800&s=701f0e4a2c63865fe7e295b6c66b543b",
        "https://si.imgix.net/a5dd8523/requests/191942_0?bg=%23fff&auto=format&txt=SAMPLE&fm=webp&w=800&s=80e19a49375f63973ffe3674553a230c",
      ...
      should parse_url("https://skeb.jp/@OrvMZ/works/3").into(
        page_url: "https://skeb.jp/@OrvMZ/works/3",
        api_url: "https://skeb.jp/api/users/OrvMZ/works/3",
        profile_url: "https://skeb.jp/@OrvMZ",
      )

      should parse_url("https://skeb.jp/works/133404").into(
        page_url: "https://skeb.jp/works/133404",
        api_url: "https://skeb.jp/api/works/133404",
      )

      should parse_url("https://si.imgix.net/17e73ecf/uploads/origins/5097b1e1-18ce-418e-82f0-e7e2cdab1cea?bg=%23fff&auto=format&txt=SAMPLE&fm=mp4&w=800&s=701f0e4a2c63865fe7e295b6c66b543b").into(
        animated?: true,
        watermarked?: true,
      )

      should parse_url("https://si.imgix.net/a5dd8523/requests/191942_0?bg=%23fff&auto=format&fm=webp&w=800&s=80e19a49375f63973ffe3674553a230c").into(
        animated?: false,
        watermarked?: false,
      )
    end
