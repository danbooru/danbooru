...
module Source::Tests::URL
  class NicoSeigaUrlTest < ActiveSupport::TestCase
    context "NicoSeiga URLs" do
      ...
      should parse_url("http://lohas.nicoseiga.jp/o/910aecf08e542285862954017f8a33a8c32a8aec/1433298801/4937663").into(
        page_url: "https://seiga.nicovideo.jp/seiga/im4937663",
      )

      should parse_url("https://seiga.nicovideo.jp/watch/mg316708").into(
        page_url: "https://manga.nicovideo.jp/watch/mg316708",
      )

      should parse_url("https://sp.manga.nicovideo.jp/watch/mg316708").into(
        page_url: "https://manga.nicovideo.jp/watch/mg316708",
      )
    end
  end
