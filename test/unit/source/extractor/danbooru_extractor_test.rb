  ...
  class DanbooruExtractorTest < ActiveSupport::ExtractorTestCase
    context "a post" do
      strategy_should_work(
        ...
        tags: %w[4girls absurdres aged_down arch armor beishang_yutou bow bowtie braid chinese_commentary closed_mouth commentary dress green_eyes hair_intakes hair_ornament hairband highres indoors long_hair looking_ahead looking_at_viewer multiple_girls orange_hair portrait profile reverse:1999 sidelighting single_braid sonetto_(reverse:1999) statue upper_body watermark white_dress white_hairband window],
        page_url: "https://danbooru.donmai.us/posts/7000000",
        profile_urls: ["https://www.pixiv.net/users/80781332"],
        artist_name: "悲伤鱼头",
