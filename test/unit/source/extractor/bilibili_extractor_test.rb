  ...
  class BilibiliExtractorTest < ActiveSupport::ExtractorTestCase
    context "A t.bilibili.com/:id post" do
      strategy_should_work(
        ...
        published_at: Time.parse("2022-07-23T12:31:28.000000Z"),
        updated_at: Time.parse("2022-07-23T12:33:00.000000Z"),
        tags: %w[],
    ...
    context "A www.bilibili.com/opus/:id large cover post" do
      strategy_should_work(
        ...
        display_name: "SA小飒",
        username: nil,
        published_at: Time.parse("2025-05-16T16:33:17.000000Z"),
        updated_at: nil,
        tags: [
          ["画师百日创作挑战", "https://www.bilibili.com/v/topic/detail/?topic_id=1288419"],
        ],
    ...
    context "A t.bilibili.com/:id quote-post" do
      strategy_should_work(
        ...
        display_name: "原子Dan",
        username: nil,
        published_at: Time.parse("2022-10-31T03:33:47.000000Z"),
        updated_at: nil,
        tags: [],
        dtext_artist_commentary_title: "",
        dtext_artist_commentary_desc: <<~EOS.chomp,
    ...
    context "A text-only t.bilibili.com post with hashtags" do
      strategy_should_work(
        ...
        display_name: "凯迪拉克官方",
        published_at: Time.parse("2022-09-19T09:12:28.000000Z"),
        updated_at: Time.parse("2022-09-19T09:12:00.000000Z"),
        tags: [
    ...
    context "A bilibili.com/read/:id post" do
      strategy_should_work(
        ...
        display_name: "花田里的碴",
        published_at: Time.parse("2020-08-27T12:30:34.000000Z"),
        updated_at: nil,
        tags: [],
    ...
    context "A bilibili.com/read/:id post with /watermark/ image URLs" do
      strategy_should_work(
        ...
        username: nil,
        published_at: Time.parse("2021-03-05T11:00:07.000000Z"),
        updated_at: Time.parse("2021-03-05T11:07:00.000000Z"),
        tags: [
    ...
    context "A t.bilibili.com post with hashtags, mentions, emotes" do
      strategy_should_work(
        ...
        published_at: Time.parse("2021-12-07T04:00:04.000000Z"),
        updated_at: Time.parse("2021-12-07T04:00:00.000000Z"),
        tags: [
    ...
    context "A t.bilibili.com/:id quote-post with images" do
      strategy_should_work(
        ...
        display_name: "绅士老鱼",
        username: nil,
        published_at: Time.parse("2024-03-29T00:50:09.000000Z"),
        updated_at: nil,
        tags: [],
        dtext_artist_commentary_title: "",
        dtext_artist_commentary_desc: <<~EOS.chomp,
