  ...
  class MihuashiExtractorTest < ActiveSupport::TestCase
    ...
    context "A Mihuashi work" do
      strategy_should_work(
        ...
        profile_url: "https://www.mihuashi.com/users/spirtie?role=painter",
        profile_urls: [
          "https://www.mihuashi.com/users/spirtie?role=painter",
          "https://www.mihuashi.com/profiles/29105?role=painter",
        ],
        display_name: "spirtie",
        username: "spirtie",
        tags: [
    ...
    context "A Mihuashi work with GIF" do
      strategy_should_work(
        ...
        profile_url: "https://www.mihuashi.com/users/yuyuco?role=painter",
        display_name: "yuyuco",
        tags: [
          ["日系", "https://www.mihuashi.com/search?tab=artwork&q=日系"],
    ...
    context "A Mihuashi stall" do
      strategy_should_work(
        ...
        profile_url: "https://www.mihuashi.com/users/黑石肆维?role=painter",
        profile_urls: [
          "https://www.mihuashi.com/users/黑石肆维?role=painter",
          "https://www.mihuashi.com/profiles/532464?role=painter",
        ],
        display_name: "黑石肆维",
        username: "黑石肆维",
        tags: [],
