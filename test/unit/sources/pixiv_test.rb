      ...
      context "A work requested via Pixiv Requests" do
        strategy_should_work(
          ...
          dtext_artist_commentary_desc: <<~EOS.chomp
            ...
            [tn]Source: https://www.pixiv.net/artworks/101951859[/tn]
            ...
            pixiv #100458225 "»":[/posts?tags=pixiv%3A100458225]
            pixiv #87275188 "»":[/posts?tags=pixiv%3A87275188]
            pixiv #96390969 "»":[/posts?tags=pixiv%3A96390969]
            ...
            [tn]Source: https://www.pixiv.net/requests/99649[/tn]
          EOS
        )
      end
