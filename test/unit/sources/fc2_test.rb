    ...
    context "FC2:" do
      ...
      context "A blog post without a mobile version" do
        strategy_should_work(
          ...
          artist_name: "killfuckdie",
          tag_name: "killfuckdie",
      ...
      context "A blog post with a nonstandard mobile version" do
        strategy_should_work(
          ...
          artist_name: "oekakigakusyuu",
          tag_name: "oekakigakusyuu",
      ...
      context "A blog post with a ?no=:id param" do
        strategy_should_work(
          ...
          dtext_artist_commentary_desc: <<~EOS.chomp
            ...
            [b]やはり時代はエロによって作られる。[/b](今週の格言)  関連記事  * " ルパン三世[レベッカ・ロッセリーニ] (2015/10/04) ":[http://abk00.blog.fc2.com/blog-entry-3055.html?sp]
