    ...
    context "Vk:" do
      ...
      context "A wall post with an outgoing link to an external site in the commentary" do
        strategy_should_work(
          ...
          artist_name: "Фан-арты «Pretty Series»",
          tag_name: "prearts",
      ...
      context "A wall post that is a repost of another post" do
        strategy_should_work(
          ...
          artist_name: "Секретный гараж | Параллельный СССР",
          tag_name: "sgips",
      ...
      context "A wall post with an attached doc file that is an image" do
        strategy_should_work(
          ...
          profile_urls: %w[https://vk.com/cloospi https://vk.com/wall-191516762],
          artist_name: "clospi",
          tag_name: "cloospi",
          other_names: ["clospi", "cloospi"],
          tags: [],
          dtext_artist_commentary_title: "",
