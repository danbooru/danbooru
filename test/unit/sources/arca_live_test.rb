    ...
    context "Arca.live:" do
      ...
      context "An Arca.live page URL with a .gif" do
        strategy_should_work(
          ...
          image_urls: %w[
            ...
            https://ac2.namu.la/20221211sac2/3e72f9e05ca97c0c3c0fe5f25632b06eb21ab9f211e9ea22816e16468ee241ca.png?type=orig
          ],
      ...
      context "An Arca.live page URL with a static emoticon" do
        strategy_should_work(
          ...
          image_urls: %w[
            https://ac2.namu.la/20220428sac2/41f472adcea674aff75f15f146e81c27032bc4d6c8073bd7c19325bd1c97d335.png?type=orig
          ],
      ...
      context "An Arca.live page URL with an animated emoticon" do
        strategy_should_work(
          ...
          image_urls: %w[
            https://ac2.namu.la/20221123sac2/14925c5e22ab9f17f2923ae60a39b7af0794c43e478ecaba054ab6131e57e022.png?type=orig
            https://ac2.namu.la/20221123sac2/50c385a4004bca44271a2f6133990f086cfefd29a7968514e9c14d6017d61265.png?type=orig
          ],
