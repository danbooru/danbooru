    ...
    context "Cohost:" do
      ...
      context "A post in reply to a non-anonymous ask" do
        strategy_should_work(
          ...
          artist_name: "Kobold Girl Tailtuft",
          tag_name: "charmyte",
      ...
      context "A post in reply to an anonymous guest ask" do
        strategy_should_work(
          ...
          artist_name: "WT (Master Cards era)",
