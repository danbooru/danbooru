      ...
      context "A public Enty page URL" do
        strategy_should_work(
          ...
          image_urls: [
            ...
            %r{https://entyjp\.s3-ap-northeast-1\.amazonaws\.com/uploads/post/attachment/141598/20211227_130_030_100\.png\?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=AKIAIMO6YQGDXLXXJKQA%2F20221225%2Fap-northeast-1%2Fs3%2Faws4_request&X-Amz-Date=.+&X-Amz-Expires=900&X-Amz-SignedHeaders=host&X-Amz-Signature=\h+},
          ],
