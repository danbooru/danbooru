    ...
    context "Behance:" do
      context "A mir-s3-cdn-cf.behance.net sample image URL" do
        strategy_should_work(
          ...
          artist_name: "Kensuke Creations",
          tag_name: "Kensukecreations",
      ...
      context "A mir-cdn.behance.net sample image URL" do
        strategy_should_work(
          ...
          artist_name: "Lise Townsend",
          tag_name: "LiseTownsend",
