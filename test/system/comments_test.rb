      ...
      context "Comments:" do
        ...
        context "the comment's dropdown menu, as a moderator" do
          ...
          should "ask for confirmation before deleting the comment" do
            within "#comment_#{@comment.id}" do
              find(".popup-menu-button").click
              accept_confirm "Are you sure you want to delete this comment?" do
                click_link "Delete"
              end
            end
          ...
          should "ask for confirmation before stickying the comment" do
            within "#comment_#{@comment.id}" do
              find(".popup-menu-button").click
              accept_confirm "Are you sure you want to sticky this comment?" do
                click_link "Sticky"
              end
            end
...
class CommentsChromeTest < ChromeSystemTestCase
  include CommentsTests
end

class CommentsFirefoxTest < FirefoxSystemTestCase
  include CommentsTests
end

class CommentsWebkitTest < WebkitSystemTestCase
  include CommentsTests
end
