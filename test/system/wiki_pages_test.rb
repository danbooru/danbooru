...
class WikiPagesChromeTest < ChromeSystemTestCase
  include WikiPagesTests
end

class WikiPagesFirefoxTest < FirefoxSystemTestCase
  include WikiPagesTests
end

class WikiPagesWebkitTest < WebkitSystemTestCase
  include WikiPagesTests
end
