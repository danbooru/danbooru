...
module Source
  class Extractor
    class Mihuashi < Source::Extractor
      ...
      def profile_url
        "https://www.mihuashi.com/users/#{Danbooru::URL.escape(username)}?role=painter" if username.present?
      end

      def account_url
        "https://www.mihuashi.com/profiles/#{user_id}?role=painter" if user_id.present?
      end
