...
ARG UBUNTU_VERSION="resolute-20260901@sha256:5212ec9732bb047ef5aed8f477787a11b079527f9f4045e7dd509c282af74b84"
# Remember to update the UBUNTU_SNAPSHOT ARG below when UBUNTU_VERSION is updated
ARG UBUNTU_SNAPSHOT="20260811T000000Z"
...
RUN <<EOS
  apt-get update
  apt-get install -y --no-install-recommends g++ make ragel git sudo gpg socat libyaml-dev libpq-dev gh ripgrep
