...
#line 1 "NONE"
	{( sm->te) = ( sm->p)+1;}
#line 843 "ext/dtext/dtext.rl"
	{( sm->act) = 104;}
	goto _again;
f75:
#line 1 "NONE"
	{( sm->te) = ( sm->p)+1;}
#line 856 "ext/dtext/dtext.rl"
	{( sm->act) = 105;}
	goto _again;
f98:
#line 1 "NONE"
